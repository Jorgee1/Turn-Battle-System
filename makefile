...
LAYOUT_CLASS_PATH    = .\layout
CHARACTER_CLASS_PATH = .\character

INCLUDE_PATHS = /I. /I$(TEXTURE_CLASS_PATH) /I$(CHARACTER_CLASS_PATH) /I$(LAYOUT_CLASS_PATH) /I$(WINDOW_CLASS_PATH) /I$(SDL_PATH)\include /I$(SDL_TTF_PATH)\include /I$(SDL_IMAGE_PATH)\include
...
OBJECTS = main.cpp $(CHARACTER_CLASS_PATH)\character.cpp $(TEXTURE_CLASS_PATH)\texture.cpp $(WINDOW_CLASS_PATH)\window.cpp $(LAYOUT_CLASS_PATH)\layout.cpp
